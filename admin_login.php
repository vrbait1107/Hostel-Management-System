  ...
  <div class="container contentContainer" id="topContainer">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-md-offset-3" id="topRow">
        <!-- COL-MD-OFFSET MOVES TO CENTRE AS 3 WILL MOVE COL-MD-6 TO 3 COLUMNS SO TO CENTRE  -->
        <h1 class="margintop" "><strong>HOSTEL MANAGEMENT SYSTEM</strong></h1>

          <p><input type=" button" class="btn btn-primary" value="Admin Login"
          onclick="location.href = 'admin_login.php'">
          <input type="button" class="btn btn-primary" value="REGISTER"
            onclick="location.href = 'registration_form.php'">
