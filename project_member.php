...
<body>
  ...
  <div class="container contentContainer">
    ...
    <div class="row marginbottom">
      ...
      <div class="col-md-4 margintop">
        <h2><span class="glyphicon glyphicon-info-sign"></span> FAQs</h2>
        <p>Frequently asked questions</p>

        <input type="button" class="btn btn-success" value="Open" onclick="location.href = 'faqs.php'">
      </div>
      <div class="col-md-4 margintop">
        <h2><span class="glyphicon glyphicon-list"></span> Room Allotment List</h2>
        <p>Gives the list of the room alloted to the students</p>
